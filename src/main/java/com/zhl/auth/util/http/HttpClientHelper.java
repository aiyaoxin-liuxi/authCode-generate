package com.zhl.auth.util.http;
...
//		String a = JSONObject.fromObject(map).toString();
    	...
    	String o = HttpClientHelper.doHttpClient("http://127.0.0.1:8080/order-site/service/orderDetailQuery", "POST", "utf-8", a.toString(), "60000","application/json","");
