...
<div class="jz_head">
    <div class="jz_top">
         <div class="jz_top-inner">
            <ul>
                <li class="jz_service"><span style="color: #dab866;"></span> 
    ...
    <div class="jz_nav">
        <div class="jz_nav_inner">
            <ul>
                ...
                <%-- 
                <img src="${basePath}/image/logo11.jpg" alt="" style="width: 185px;position: relative;top:8px;"/>
                 --%>
                </li>
                <li class="jz_link"><a href="${basePath }/compayinfo/loginOut?userType=03">退出</a> &nbsp;</li>
                <li>
