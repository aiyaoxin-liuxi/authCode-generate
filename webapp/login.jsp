            ...
            <form class="form-horizontal" action="" id="loginForm">
                <fieldset>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="Username" value="12">
                    </div>
                    ...
                    <div class="input-prepend">
                        <label class="remember" for="remember"><input type="checkbox" id="remember"> Remember me2</label>
                    </div>
                    <div class="clearfix"></div>
